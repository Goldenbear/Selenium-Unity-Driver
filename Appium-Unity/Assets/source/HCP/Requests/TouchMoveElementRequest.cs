...
{
    public class TouchMoveElementRequest : JobRequest
    {
        ...
        public TouchMoveElementRequest(JSONClass json) : base(json)
        {
        }
        ...
        public override JobResponse Process()
        {
          var toTouch = JobRequest.GetElementById(this.Id);
            ...
            ExecuteEvents.Execute(toTouch.gameObject, ptr, ExecuteEvents.moveHandler);
