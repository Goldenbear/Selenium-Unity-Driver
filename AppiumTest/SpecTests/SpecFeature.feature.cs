...
namespace AppiumTest.SpecTests
{
    ...
    public partial class SpecTestFeature : Xunit.IClassFixture<SpecTestFeature.FixtureData>, System.IDisposable
    {
        
        private static TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "SpecFeature.feature"
#line hidden
        
        public SpecTestFeature()
        {
            this.TestInitialize();
        }
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SpecTest", "\tIn order to show how spec flow works\r\n\tAs a simple example\r\n\tI want to click a b" +
        ...
        public virtual void SetFixture(SpecTestFeature.FixtureData fixtureData)
        {
        }
        ...
        [Xunit.TraitAttribute("FeatureTitle", "SpecTest")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                SpecTestFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                SpecTestFeature.FeatureTearDown();
            }
        }
    }
}
